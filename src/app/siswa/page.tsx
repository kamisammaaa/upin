...
import { Book, Clock, LogOut, CheckCircle2, AlertCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-crypto-bg text-gray-100 font-sans pb-12">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 mt-8">
        <div className="bg-crypto-card rounded-2xl border border-crypto-border p-5 mb-8 sm:hidden shadow-lg">
