...
import { updateGuru } from '@/app/actions/guru';
...
export default function EditGuruClient({ guru }: { guru: Guru }) {
  ...
  return (
    <div className="w-full space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold text-white tracking-wide">Edit Data Guru</h2>
          <p className="text-sm text-gray-400 mt-1">Ubah profil atau reset password guru terpilih.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-crypto-card p-5 sm:p-8 rounded-2xl border border-crypto-border space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-300 mb-2">Password Baru (Opsional)</label>
            <div className="relative">
